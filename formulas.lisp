...
(defmethod add-constant ((sig signature) constant)
  (cond ((predicate? sig constant)
	 (error "The symbol ~A is already reserved as a predicate in the the given signature" constant))
	((function? sig constant)
