...
(defparameter famous-formulas
  `(("Peirce's formula" "peirce-formula" ,peirce-formula)
    ...
    ("Not-and implies or-not" "de-morgan-not-and-implies-or-not" ,de-morgan-not-and-implies-or-not)
    ("Not-or implies and-not" "de-morgan-not-or-implies-and-not" ,de-morgan-not-or-implies-and-not)
    ("And-not implies not-or" "de-morgan-and-not-implies-not-or" ,de-morgan-and-not-implies-not-or)
    ("Or-not implies not-and" "de-morgan-or-not-implies-not-and" ,de-morgan-or-not-implies-not-and)
...
(defun formula-guide ()
  ...
  (<:blockquote
   (render (make-implication excluded-middle ex-contradictione-quodlibet)))
