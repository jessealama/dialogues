...
* IN-PROGRESS Document the accepted syntax for inputting formulas.
  It's lispy.
...
* TODO Provide some kind method for checking whether the input formula is correct according to the signature
