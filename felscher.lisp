  ...
  (make-instance 'ruleset
		 :rules (append argumentation-forms
				(list rule-d00-atomic
				      ...
				      rule-d13
				      rule-e
				      proponent-no-duplicate-repeats))
		 :description "E rules (D rules + Opponent must always respond to the immediately previous move); Proponent duplicate repetitions disallowed"))
