...
(defparameter famous-formulas
  `(("Peirce's formula" "peirce-formula" ,peirce-formula)
    ...
    ("¬(P &amp; Q) &rarr; (¬P | ¬Q)" "de-morgan-not-and-implies-or-not" ,de-morgan-not-and-implies-or-not)
    ("¬(P | Q) &rarr; (¬P &amp; ¬Q)" "de-morgan-not-or-implies-and-not" ,de-morgan-not-or-implies-and-not)
    ("(¬P &amp; ¬Q) &rarr; ¬(P | Q)" "de-morgan-and-not-implies-not-or" ,de-morgan-and-not-implies-not-or)
    ("(¬P | ¬Q) &rarr; ¬(P &amp; Q)" "de-morgan-or-not-implies-not-and" ,de-morgan-or-not-implies-not-and)
