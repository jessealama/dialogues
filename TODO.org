...
*** TODO Change "The signature that will be used" to just "Signature"
*** TODO Link "Signature" to a pop-up window that allows you to edit the sig.
*** TODO Change "Enter a formula or choose a famous formula from the menu" to "Formula"
    And to have just the drop-down menu, with one option being "enter a formula manually", which goes to another
...
*** TODO Change "Select a translation to be applied to the selected formula:" to "Translation"
*** TODO Link the word "Translation" to a pop-up window
