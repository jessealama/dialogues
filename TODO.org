...
* TODO Sara's style suggestions
  - There is too much text, on both the front page and the internal
pages.
  - A navigational sidebar (and also maybe a pretty heading banner?)
would be nice.  The sidebar would include the following links:
       - "Play a game"
       - "Search for a winning play"
       - "Search for a winning strategy"
       - "About dialogical logic"
       - "About the website"
       - a link to the blog? (if not linked from the "about dl"
         page)
       - a contact link
  - Not entirely sure what should then go onto the main front page;
    I would start with nothing for the time being.
  - For the "play the game" page
    - remove "about Lorenzen dialogue games", since that goes into
      the "about dl" page.
    - Change "The signature that will be used" to just "Signature",
      and link "Signature" to a pop-up window that allows you to edit
      the sig.
    - Change "Enter a formula or choose a famous formula from the
      menu" to "Formula", and have just the drop-down menu, with one
      option being "enter a formula manually", which goes to another
      pop-up window.  Not entirely sure yet where the table of famous
      formula names should go, or the info about LISP notation.  The
      latter can probably just remain on "play the game" page.
    - Change "Select a translation to be applied to the selected
      formula:" to "Translation", and link the word to a pop-up window
      w/ the info currently at the bottom of the page.
    - Ditto for rules & play style.
